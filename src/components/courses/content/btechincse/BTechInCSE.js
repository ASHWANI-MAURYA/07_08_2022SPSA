...
const BTechInCSE = () => {
  return (
    ...
    <Helmet>
        ...
        />
        <link rel="canonical" href="https://spsu.ac.in/btech-in-computer-science-engineering"></link>
      </Helmet>
      <IconTabBar
        tabs={[
          {
      ...
      <FaqAns
        listanswer={[
          ...
          },
          {
            ...
            ans: "The Government of India has appointed a task force planning to boost the AI sector in India, for developing AI technologies and infrastructure, to data usage and research to work with the private sectors to develop technologies, with a focus on smart cities, manufacturing, agriculture and crop management, health care, education, public utilities and to fight against terrorism. Therefore, ample career opportunities exist in private companies, public organizations, education, government institutions, and the healthcare industry. Additionally, top IT companies are actively hiring Engineers specializing in Artificial Intelligence & Machine Learning. After graduation students can explore job profiles like Machine Learning Engineer, Data Scientist in Machine Learning, Research Engineer in Artificial Intelligence, Big Data & AI Architect, Big Data & AI Consultant, Robotics Professional, Atkins, Accenture, Bosch Group, Microsoft, Amazon, Intel Technology, Reliance Jio, Google"
          }
        ]}
      />
    </>
