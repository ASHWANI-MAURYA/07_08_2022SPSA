  ...
  return (
    <div className="general-section">
      <div className="general">
        ...
        Every business, from the production of basic needle parts to the intricate sections of airplanes, utilizes minerals, making mining the mother of all industries and a significant element of our economy.
        <br/>
        <br/>
